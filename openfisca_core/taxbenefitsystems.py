...
class TaxBenefitSystem(object):
    ...
    def add_variable(self, variable):
        ...
        :param variable: The variable to add. Must be a sublcass of Variable.

        :raises: :any:`VariableNameConflict` if a variable with the same name have previously been added to the tax benefit system.
        """
    ...
    def update_variable(self, variable):
        ...
        :param variable: Variable to add. Must be a sublcass of Variable.
        """
